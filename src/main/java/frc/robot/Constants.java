...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final double kFrontLeftDriveAbsoluteEncoderOffsetRad = 0.1411;
        public static final double kBackLeftDriveAbsoluteEncoderOffsetRad = 4.2966;
        public static final double kFrontRightDriveAbsoluteEncoderOffsetRad = 1.7671;
        public static final double kBackRightDriveAbsoluteEncoderOffsetRad = 1.5846;

        public static final double kPhysicalMaxSpeedMetersPerSecond = 5; // Was 5 
  ...
  //PID constant bellow
    public static final int PIDTestController = 41;
}